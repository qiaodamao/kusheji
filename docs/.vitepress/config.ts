    ...
    themeConfig: {
        ...
        heroBgImage: [ //首页大图自定义背景，heroBgMode 为 'custom' 时生效，每次刷新随机显示一张，不需要就注释掉
            {
                ...
                image: 'https://wkphoto.bj.bcebos.com/d833c895d143ad4bcabfb29892025aafa50f06d0.jpg',
                title: '国内外矢量LOGO下载'
            },
            {
        ...
        //    },
            {
                ...
                }, link: 'https://github.com/qiaodamao/kusheji'
            }
        ],
        docFooter: {
            prev: '上一篇',
        ...
        article: {
            cc: {
                ...
                authorLink: 'https://logo.kusheji.com/',
